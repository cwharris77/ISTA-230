...
function selectionChanged() {
	...
	// Your code goes here
	let bool = selectedHero.battle(selectedVillain);
	
	if (bool){
		winner = document.getElementById("winner");
		winner.innerText = "Winner: " + selectedHero.alias + "!";
		winner.style.display = "show"
	} else {
		winner = document.getElementById("winner");
		winner.innerText = "Winner: " + selectedVillain.alias + "!";
		winner.display = "show";
	}
